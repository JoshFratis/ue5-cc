...
void APlayerCharacter::BeginPlay()
{
	...
	if (PlayerController)
		InputYawScale = PlayerController->GetDeprecatedInputYawScale();
	UE_LOG(LogTemp, Warning, TEXT("Input Yaw Scale: %f"), InputYawScale);
}
...
void APlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	Input->BindAction(DilateTimeInputAction, ETriggerEvent::Triggered, this, &APlayerCharacter::DilateTime);
	Input->BindAction(EngageInputAction, ETriggerEvent::Triggered, this, &APlayerCharacter::Engage);
	Input->BindAction(DisengageInputAction, ETriggerEvent::Triggered, this, &APlayerCharacter::Disengage);
	Input->BindAction(StrikeInputAction, ETriggerEvent::Triggered, this, &APlayerCharacter::Strike);
...
{
	UE_LOG(LogTemp, Log, TEXT("Strike"));
}

void APlayerCharacter::Disengage()
{
	IsEngaged = false;
}
